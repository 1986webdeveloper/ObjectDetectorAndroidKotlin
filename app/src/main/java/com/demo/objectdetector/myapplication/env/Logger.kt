...
package com.demo.objectdetector.myapplication.env
 ...
 * being used
 */
    constructor(private val tag: String = DEFAULT_TAG, messagePrefix: String? = null) {
    ...
    companion object {
        ...
        init {
            ...
            IGNORED_CLASS_NAMES.add(Logger::class.java.canonicalName?:"NoName")
        }
